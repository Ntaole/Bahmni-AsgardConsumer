...
function start {
    echo "Executing command: 'docker compose up -d' with the images specified in the environment file"
    echo "Starting Bahmni with default profile from environment file"
...
function sshIntoService {
    ...
    docker compose --env-file .env exec $serviceName /bin/sh
}
...
function showLogsOfService {
    ...
    docker compose --env-file .env logs $serviceName -f
}
...
function pullLatestImages {
    echo "Pulling all the images specified in the environment file..."
...
function restartService {
    ...
    docker compose --env-file .env restart $serviceName
